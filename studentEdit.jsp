...
<form method="post">
  ...
  <a href="studentDeleteAction.jsp?id=<%= id %>" class="btn" onclick="return confirm('삭제하시겠습니까?');"> 
  	<i class="icon-remove"></i> 삭제 </a> 
  <a href="studentList1.jsp" class="btn"> 
  	<i class="icon-list"></i> 목록으로 </a>
</form>
